 ...
 */
final class Version20191030125123 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE result (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, response_id INT NOT NULL, question_id INT NOT NULL, quiz_id INT NOT NULL, INDEX IDX_136AC113A76ED395 (user_id), INDEX IDX_136AC113FBF32840 (response_id), INDEX IDX_136AC1131E27F6BF (question_id), INDEX IDX_136AC113853CD175 (quiz_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
